 ...
 */
	...
	$.jstree.core.prototype = {
		 ...
		 * @param {mixed} obj
		 * @param {String} icon the new icon - can be a path to an icon or a className, if using an img that is in the current directory use a `./` prefix, otherwise it will be detected as a class
		 */
 ...
 */
	...
	$.jstree.defaults.contextmenu = {
		 ...
		 * * `icon` - a string, can be a path to an icon or a className, if using an img that is in the current directory use a `./` prefix, otherwise it will be detected as a class
	...
	$(function() {
		...
		$(document)
			...
			.on('dnd_move.vakata.jstree', function (e, data) {
				...
				// if we are hovering the marker img do nothing (can happen on "inside" drags)
 ...
 */
	 ...
	 * * `icon` a string - can be a path to an icon or a className, if using an img that is in the current directory use a `./` prefix, otherwise it will be detected as a class. Omit to use the default icon from your theme.
	 *
